...
<div class="wrapper">
  <table>
    <tbody>
      ...
      <tr>
        <td>返金</td>
        <td>決済手数料がかかっているため、原則返金は出来ません</td>
      </tr>
      <tr>
        <td>基本価格</td>
        <td>
          AI解析時における送信文字・返却文字の合計が10文字当たり0.012円<br />
          (1回当たりの最大解析文字数は2700文字で、その場合の金額は3.3円となります)
          <br />
          <br />
          ...
          >
            こちらのサイト
          </a> で文字を入力し、characters にある数値をご確認ください。
        </td>
      </tr>
      <tr>
        <td>機能価格</td>
